...
Такая же — новая, прежняя.`,
  },
  {
    ...
    title: 'По жизни иду',
    date: 'Август 1999',
    tags: ['жизнь', 'равновесие', 'вдохновение'],
    preview: 'По жизни иду, как по рельсе —\nНу кто по ним не ходил?\nПроверить своё равновесье\nСтараюсь я каждый день.',
    full: `По жизни иду, как по рельсе —
Ну кто по ним не ходил?
Проверить своё равновесье
Стараюсь я каждый день.

Но мысли мои, но чувства —
Проходят по мне, как состав...
Волнующий миг вдохновенья,
Одну меня не оставь!`,
  },
];
      ...
      <div className="max-w-3xl mx-auto text-center px-4 py-20">
        ...
        <div className="opacity-0 animate-fade-up" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
          <h1 className="font-cormorant leading-tight mb-4">
            ...
            <span className="font-bold block text-4xl md:text-5xl lg:text-6xl mt-3" style={{ color: 'hsl(345 65% 30%)' }}>Ирины Кузьминой</span>
          </h1>
        </div>
